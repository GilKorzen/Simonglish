...
public class MainEasyGame extends AppCompatActivity implements View.OnClickListener {
    final static int level = 3;
    ImageButton red, blue, yellow, settings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_easy_game);
    ...
    public void onClick(View view) {
        ...
        if (view == back_to_menu) {
            losing_Dialog.dismiss();
            menu= new Intent(MainEasyGame.this, MainMenu.class);
            menu.putExtra("email",getIntent().getExtras().getString("email"));
            startActivity(menu);

        }

        if (view == blue || view == yellow || view == red) {
    ...
    public void dialog_setting_things() {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                exit = new Intent(MainEasyGame.this, MainMenu.class);
    ...
    private void savingScore(int score) {
        ...
        try {
            if (!getIntent().getExtras().getString("email").equals("")) {
                sendingData.put("request", "saveEasy");
    ...
    //creates notification
    {
        ...
        String text=name+ " just achieved the highest score in the easy mode with a score of"+ record+ " points!!!";
