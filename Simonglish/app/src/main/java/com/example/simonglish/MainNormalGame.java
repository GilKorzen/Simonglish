...
public class MainNormalGame extends AppCompatActivity implements View.OnClickListener {
    final static int level = 4;
    ImageButton red, blue, green, yellow, settings;
        ...
        if (view == settings) {
            ...
            if (view == restart) {
                ...
                if (view == back_to_menu) {
                    losing_Dialog.dismiss();
                    menu= new Intent(MainNormalGame.this, MainMenu.class);
                    menu.putExtra("email",getIntent().getExtras().getString("email"));
                    startActivity(menu);

                }

                    if (view == blue || view == green || view == yellow || view == red) {
    ...
    public void dialog_setting_things() {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                exit = new Intent(MainNormalGame.this, MainMenu.class);
    ...
    private void savingScore(int score) {
        ...
        try {
            if (!getIntent().getExtras().getString("email").equals("")) {
                sendingData.put("request", "saveMedium");
            ...
            //creates notification
    {
        ...
        String text=name+ " just achieved the highest score in the medium mode with a score of"+ record+ " points!!!";

        Intent intent = new Intent(MainNormalGame.this, Leaderboards.class);
        intent.putExtra("email", getIntent().getExtras().getString("email"));
        intent.putExtra("position",1);
        PendingIntent pendingIntent = PendingIntent.getActivity(MainNormalGame.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
